...
set output "test.tex"
set arrow from first 3500, -60 to first 3500, 140 nohead
set label "A" at first 3300, 150
set arrow from first 5000, -60 to first 5000, 140 nohead
set label "B" at first 4800, 150
set arrow from first 7500, -60 to first 7500, 140 nohead
set label "C" at first 7300, 150
