...
plot "01-synaptic-weights-EE-mean-all.txt" using ($1/1000):2:($2-$3/2):($2+$3/2) with errorbars lw 5 title "EE (SD) ", "01-synaptic-weights-EE-mean-all.txt" using ($1/1000):2 with linespoints lw 5 title "EE (Mean)", "01-synaptic-weights-EI-mean-all.txt" using ($1/1000):2:($2-$3/2):($2+$3/2) with errorbars lw 5 title "EI (SD)", "01-synaptic-weights-EI-mean-all.txt" using ($1/1000):2 with linespoints lw 5 title "EI (Mean)", "01-synaptic-weights-II-mean-all.txt" using ($1/1000):2:($2-$3/2):($2+$3/2) with errorbars lw 5 title "II (SD)", "01-synaptic-weights-II-mean-all.txt" using ($1/1000):2 with linespoints lw 5 title "II (Mean)", "01-synaptic-weights-IE-mean-all.txt" using ($1/1000):(-1*$2):(-1*($2-$3/2)):(-1*($2+$3/2)) with errorbars lw 5 title "IE (SD)", "01-synaptic-weights-IE-mean-all.txt" using ($1/1000):(-1*$2) with linespoints lw 5 title "IE (Mean)"
