...
do for [pat=1:numpats+0] {
    ...
    if (file_exists(infile)) {
        ...
        plot infile with lines lw 4 title "P", 3 with lines lw 2 title "T"
    }
    ...
    if (file_exists(infile)) {
        ...
        plot infile with lines lw 4 title "BGE", 3 with lines lw 2 title "T"
    }
    ...
    if (file_exists(infile)) {
        ...
        plot infile with lines lw 4 title "DP", 3 with lines lw 2 title "T"
    }
    ...
    if (file_exists(infile)) && (file_exists(infile1)) {
        ...
        plot infile with lines lw 4 title "P", infile1 with lines lw 4 title "DP"
    }
    ...
    if (file_exists(infile)) && (file_exists(infile1)) {
        ...
        plot infile with lines lw 4 title "BGE", infile1 with lines lw 4 title "DBGE"
    }
    ...
    if (file_exists(infile)) && (file_exists(infile1)) {
        ...
        plot infile with lines lw 4 title "BGI", infile1 with lines lw 4 title "DBGI"
    }
}
