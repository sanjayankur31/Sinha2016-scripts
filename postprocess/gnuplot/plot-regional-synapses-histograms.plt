...
set term pngcairo font "OpenSans, 28" size 1920, 2160
...
set title "II"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_c_I-II.txt' using COL:xtic(1) title columnheader

set title "EI"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_c_I-EI.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "IE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_c_E-IE.txt' using COL:xtic(1) title columnheader

set title "EE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_c_E-EE.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "II"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_b_I-II.txt' using COL:xtic(1) title columnheader

set title "EI"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_b_I-EI.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "IE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_b_E-IE.txt' using COL:xtic(1) title columnheader

set title "EE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-lpz_b_E-EE.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "II"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-p_lpz_I-II.txt' using COL:xtic(1) title columnheader

set title "EI"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-p_lpz_I-EI.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "IE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-p_lpz_E-IE.txt' using COL:xtic(1) title columnheader

set title "EE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-p_lpz_E-EE.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "II"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-o_I-II.txt' using COL:xtic(1) title columnheader

set title "EI"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-o_I-EI.txt' using COL:xtic(1) title columnheader
unset multiplot
...
set title "IE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-o_E-IE.txt' using COL:xtic(1) title columnheader

set title "EE"
plot for [COL=5:2:-1] '081-syn_conns-incoming-hist-o_E-EE.txt' using COL:xtic(1) title columnheader
unset multiplot
