...
set ylabel "dz/dt"
set label "{/Symbol h}_{de}" at (eta_d_E_e + 0.01), 0.00001
set label "{/Symbol h}_{di}" at (eta_d_E_i + 0.01), 0.00001
...
plot [x=0:xmax_E] dzdt(x, nu_d_E_e, zeta_d_E_e, xi_d_e) w lines lw 2 title 'Dendritic E', [x=0:xmax_E] dzdt(x, nu_d_E_i, zeta_d_E_i, xi_d_i) w lines lw 2 title 'Dendritic I', [x=0:xmax_E] dzdt(x, nu_ax_E, zeta_ax_E, xi_a) w lines lw 2 title 'Axonal', 0 title "";
...
set xlabel "Calcium concentration"
set ylabel "dz/dt"
set label "{/Symbol h}_{de}" at (eta_d_I_e + 0.01), 0.00001
set label "{/Symbol h}_{di}" at (eta_d_I_i + 0.01), 0.00001
...
plot [x=0:xmax_I] dzdt(x, nu_d_I_e, zeta_d_I_e, xi_d_e) w lines lw 2 title 'Dendritic E', [x=0:xmax_I] dzdt(x, nu_d_I_i, zeta_d_I_i, xi_d_i) w lines lw 2 title 'Dendritic I', [x=0:xmax_I] dzdt(x, nu_ax_I, zeta_ax_I, xi_a) w lines lw 2 title 'Axonal', 0 title "";
