...
plot  "081-conductance-net-lpz_b_E.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;

old_g = NaN
set output "08-net-conductances-slope-to-p_lpz_E.png"
set title "Rate of change of incoming net conductance to peri LPZ E"
plot  "081-conductance-net-p_lpz_E.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;

old_g = NaN
set output "08-net-conductances-slope-to-o_E.png"
set title "Rate of change of incoming net conductance to other E neurons"
plot  "081-conductance-net-o_E.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;
...
plot  "081-conductance-net-lpz_c_I.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;

old_g = NaN
set output "08-net-conductances-slope-to-lpz_b_I.png"
set title "Rate of change of incoming net conductance to LPZ B I"
plot  "081-conductance-net-lpz_b_I.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;

old_g = NaN
set output "08-net-conductances-slope-to-p_lpz_I.png"
set title "Rate of change of incoming net conductance to peri LPZ I"
plot  "081-conductance-net-p_lpz_I.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;

old_g = NaN
set output "08-net-conductances-slope-to-o_I.png"
set title "incoming net conductance to other I neurons"
plot  "081-conductance-net-o_I.txt" using 1:delta_g($2+$3+$4+$5) with linespoints lw 5 lc 1;
