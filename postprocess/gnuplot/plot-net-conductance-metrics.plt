...
plot  "081-conductance-net-lpz_c_E.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-lpz_b_E.png"
set title "Incoming net conductance to LPZ B E"
plot  "081-conductance-net-lpz_b_E.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-p_lpz_E.png"
set title "Incoming net conductance to peri LPZ E"
plot  "081-conductance-net-p_lpz_E.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-o_E.png"
set title "Incoming net conductance to other E neurons"
plot  "081-conductance-net-o_E.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

# Net totals I
set output "08-net-conductances-to-lpz_c_I.png"
set title "Incoming net conductance to LPZ C I"
plot  "081-conductance-net-lpz_c_I.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-lpz_b_I.png"
set title "Incoming net conductance to LPZ B I"
plot  "081-conductance-net-lpz_b_I.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-p_lpz_I.png"
set title "Incoming net conductance to peri LPZ I"
plot  "081-conductance-net-p_lpz_I.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";

set output "08-net-conductances-to-o_I.png"
set title "Incoming net conductance to other I neurons"
plot  "081-conductance-net-o_I.txt" using 1:($2+$3+$4+$5) with linespoints lw 5 lc 1 title "";
