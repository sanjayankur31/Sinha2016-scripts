...
plot "std-rate-E.gdf" with linespoints lw 2 title "E", 5 with lines lw 2 title "5Hz"

set output "std-I.png"
set title "STD of firing rates for I neurons"
plot "std-rate-I.gdf" with linespoints lw 2 title "I", 5 with lines lw 2 title "5Hz"
