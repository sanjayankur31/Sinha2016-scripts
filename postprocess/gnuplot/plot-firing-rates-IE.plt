...
set title "Mean firing rate for lpz neurons"
plot "mean-firing-rates-o_I.gdf" with lines ls 6 title "non lpz I", "mean-firing-rates-o_E.gdf" with lines ls 1  title "non lpz E", 3 with lines ls 9 title "T";
...
set title "Mean firing rate for neurons in various regions"
plot "mean-firing-rates-lpz_c_I.gdf" with lines ls 1  title "lpz center I", "mean-firing-rates-lpz_b_I.gdf" with lines ls 3  title "lpz border I", "mean-firing-rates-p_lpz_I.gdf" with lines ls 5  title "peri lpz I", "mean-firing-rates-o_I.gdf" with lines ls 6 title "non lpz I", 3 with lines ls 9 title "T";
